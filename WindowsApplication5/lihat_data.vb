Public Class lihat_data
    ...
    Public Sub dg_lihat()
        ...
        open_con()
        rec.Open("select anggota.nama,buku.judul,peminjaman.jumlah_pinjam,peminjaman.tanggal_pinjam,peminjaman.date_kmbali from peminjaman join buku join anggota  on buku.kd_buku = peminjaman.kd_buku and anggota.kd_anggota = peminjaman.kd_Anggota ", conn, 3, 2)
        Do While Not rec.EOF
